...
<head>
    ...
    @else
        ...
        <link rel="stylesheet" crossorigin href="{{ asset('admin_panel/compiled/css/iconly.css') }}">
    @endif
</head>
...
@hasSection('sctipts')
    @yield('scripts')
@else
    <script src="{{ asset('admin_panel/static/js/components/dark.js') }}"></script>
    <script src="{{ asset('admin_panel/extensions/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('admin_panel/compiled/js/app.js') }}"></script>
    <script src="{{ asset('admin_panel/extensions/apexcharts/apexcharts.min.js') }}"></script>
    <script src="{{ asset('admin_panel/static/js/pages/dashboard.js"') }}"></script>
@endif
