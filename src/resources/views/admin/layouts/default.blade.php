...
<head>
    ...
    @hasSection('styles')
        @yield('styles')
        @vite(['resources/admin/sass/mazer.sass'])
    @else
        @vite(['resources/admin/sass/mazer.sass'])
    @endif
</head>
...
<body>
    <div id="app">
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item has-sub {{ request()->route()->getName() == 'admin.scraper.index' ? 'active' : '' }}">
                            <a href="#" class='sidebar-link'>
                                <i class="bi bi-stack"></i>
                                <span>Модули</span>
                            </a>
                            <ul
                                class="submenu {{ request()->route()->getName() == 'admin.scraper.index' ? 'active submenu-open' : '' }}">
                                <li
                                    class="submenu-item {{ request()->route()->getName() == 'admin.scraper.index' ? 'active' : '' }}">
                                    <a href="{{ route('admin.scraper.index') }}"
                                        class="submenu-link {{ request()->route()->getName() == 'admin.scraper.index' ? 'active' : '' }}">Парсер</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        @hasSection('scripts')
            @vite(['resources/admin/js/mazer.js'])
            @yield('scripts')
        @else
            @vite(['resources/admin/js/mazer.js'])
        @endif
